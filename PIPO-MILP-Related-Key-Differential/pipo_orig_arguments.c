...
void ROUND_KEY_GEN(char* plain_1,char* plain_0,char* key_3,char* key_2,char* key_1,char* key_0) {
	u32 i, j;
	u32 RCON = 0;
	srand(time(NULL));
	printf("%s,%s\n", plain_1,plain_0);
	...
	PLAIN_TEXT[0] = (int)strtol(plain_0, NULL, 16);
	PLAIN_TEXT[1] = (int)strtol(plain_1, NULL, 16);
	...
	MASTER_KEY[0] = (int)strtol(key_0, NULL, 16);;
	MASTER_KEY[1] = (int)strtol(key_1, NULL, 16);;
	MASTER_KEY[2] = (int)strtol(key_2, NULL, 16);;
	MASTER_KEY[3] = (int)strtol(key_3, NULL, 16);
...
int main(int argc, char** argv) {
	...
	ROUND_KEY_GEN(argv[1],argv[2],argv[3],argv[4],argv[5],argv[6]);
